...
module.exports = class HanaTemplate extends require('../../plugin') {
    ...
    async combine() {
        const project = readProject()
        const { addMta, hasMta, addHelm, addHelmUnifiedRuntime, addMultitenancy, addContainerize, isJava, hasHelm, hasHelmUnifiedRuntime, hasMultitenancy, srvPath } = project
        ...
        if (addMultitenancy && (hasHelm || hasHelmUnifiedRuntime)) {
