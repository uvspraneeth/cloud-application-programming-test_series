        ...
        const reserved = {
            ...
            apps: () => {
                ...
                return apps.map((app, i) => {
                    ...
                    let archiveName = ''
                    const ui5DeployPath = path.resolve(cds.root, cds.env.folders.app, app, 'ui5.yaml')
                    if (exists(ui5DeployPath)) {
                        const ui5Deploy = cds.load.yaml(ui5DeployPath)
                        const customTasks = ui5Deploy?.builder?.customTasks
                        if (Array.isArray(customTasks)) {
                            const zipperTask = customTasks.find(t => t.name === 'ui5-task-zipper')
